...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="min-h-screen px-6 md:px-16 py-20 bg-linear-to-br from-gray-900 via-slate-900 via-slate-900 text-white"
    >
      {/* Header */}
        ...
        {ProjectsData.map((project) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-3xl bg-linear-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10">
              <div className="absolute `inset-0.5` rounded-3xl bg-linear-to-br from-gray-800 to-gray-900"></div>
            </div>
          </div>
        ))}
      </div>
