...
export default function About() {
    return (
        ...
        <img
          src={EliasImage}
          alt="Elias Dugasa"
          className="w-64 h-64 md:w-80 md:h-90 object-contain  rounded-2xl shadow-lg"
        />
      </div>
